        ...
        <div className="flex pl-64 pb-[4.6rem] items-center">
          <div>
            ...
            <div className="flex items-center">
              ...
              <button className="border rounded-xl text-sm bg-indigo-950 text-white pt-1.5 pb-1.5 pl-1 ml-1 w-28 text-center hover:bg-indigo-800">My Resume <ArrowOutwardIcon fontSize="small" /></button>
            </div>
